...
![image-20260925105506690](桌面项目笔记.assets/image-20260925105506690.png)
...
![image-20260925110210758](桌面项目笔记.assets/image-20260925110210758.png)
...
Conventional Commits 前缀表

先说清楚：**这不是 Git 的语法要求**。你在 `-m` 里写「今天天气不错」Git 也照收。它是**开发者社区的自律约定**，好处是历史一眼可读、以后能自动生成更新日志和版本号。

![image-20260925222053187](桌面项目笔记.assets/image-20260925222053187.png)
...
6.![image-20260925222346874](桌面项目笔记.assets/image-20260925222346874.png)
...
2. ![image-20260925230616955](桌面项目笔记.assets/image-20260925230616955.png)
...
1. 代码：
   ...
   ```
   git commit -m "docs:新增桌面项目笔记"
   ```

2. 输出结果：

   ```
   [main 3f9a1c2] docs: 新增桌面项目笔记
    1 file changed, 9 insertions(+)
   ```

3. ![image-20260926091238071](桌面项目笔记.assets/image-20260926091238071.png)